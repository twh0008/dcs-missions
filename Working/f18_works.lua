...
SPAWN_NATO_AWACS = SPAWN:New("NATO AWACS"):InitLimit(1,999)
SPAWN_NATO_AWACS:InitRepeatOnLanding()

SPAWN_NATO_TANKER = SPAWN:New("NATO TANKER"):InitLimit(1,999)
SPAWN_NATO_TANKER:InitRepeatOnLanding()

SPAWN_OPFOR_AWACS = SPAWN:New("RED AWACS"):InitLimit(1,999)
SPAWN_OPFOR_AWACS:InitRepeatOnLanding()

SPAWN_NATO_TANKER:SpawnScheduled(30,0)
SPAWN_NATO_AWACS:SpawnScheduled(30,0)  
SPAWN_OPFOR_AWACS:SpawnScheduled(30,0)
...
A2ADispatcher:SetSquadronTakeoffInAir("Maykop", 10000)
A2ADispatcher:SetSquadronTakeoffInAir("Sochi", 10000)
A2ADispatcher:SetSquadronTakeoffInAir("Gudauta", 10000)
...
ZoneTable = { ZONE:New( "Zone 1" ), ZONE:New( "Zone 2" ), ZONE:New( "Zone 3" ) }
